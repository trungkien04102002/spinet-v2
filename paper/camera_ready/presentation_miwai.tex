...
\begin{itemize}\scriptsize
    ...
    \item[--] The weak labels are weak \textbf{for reasons}: spondylolisthesis and endplate are about bone, not disc shape; Pfirrmann is 5-class; Modic needs the paired \textbf{T1} that SPIDER's T2-FS does not have.
\end{itemize}
\end{frame}
