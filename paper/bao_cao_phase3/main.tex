...
Bảng~\ref{tab:phase2detail} tách số theo từng điều kiện và từng mức độ, lấy từ chương 5 luận văn
(seed 42). Đây là mức chi tiết để trả lời khi được hỏi ``trước đó mô hình làm được tới đâu''.

\begin{table}[htbp]
\centering\small
\caption{Recall / Precision / F1 theo điều kiện $\times$ mức độ (nền $\to$ Hybrid), seed 42.}
\label{tab:phase2detail}
\setlength{\tabcolsep}{4pt}
\begin{tabular}{llccc}
\toprule
\textbf{Điều kiện} & \textbf{Mức độ} & \textbf{Recall} & \textbf{Precision} & \textbf{F1} \\
\midrule
Ống sống & Normal/Mild & 98{,}6 $\to$ 92{,}8 & 91{,}1 $\to$ 96{,}4 & 0{,}947 $\to$ 0{,}946 \\
Ống sống & Moderate    & 7{,}9 $\to$ \up{42{,}4}  & 33{,}3 $\to$ 32{,}4 & 0{,}128 $\to$ \up{0{,}368} \\
Ống sống & \textbf{Severe} & 35{,}8 $\to$ \up{70{,}4} & 63{,}0 $\to$ 55{,}9 & 0{,}457 $\to$ \up{0{,}623} \\
\midrule
Lỗ trái & Normal/Mild & 96{,}2 $\to$ 54{,}5 & 80{,}4 $\to$ 93{,}4 & 0{,}876 $\to$ 0{,}688 \\
Lỗ trái & Moderate    & 18{,}6 $\to$ \up{76{,}4} & 46{,}2 $\to$ 28{,}2 & 0{,}265 $\to$ \up{0{,}412} \\
Lỗ trái & \textbf{Severe} & \textbf{0{,}0} $\to$ \up{18{,}8} & \textbf{0{,}0} $\to$ \up{17{,}2} & \textbf{0{,}000} $\to$ \up{0{,}180} \\
\midrule
Lỗ phải & Normal/Mild & 96{,}2 $\to$ 58{,}6 & 79{,}5 $\to$ 94{,}1 & 0{,}871 $\to$ 0{,}723 \\
Lỗ phải & Moderate    & 16{,}7 $\to$ \up{75{,}8} & 43{,}4 $\to$ 30{,}9 & 0{,}241 $\to$ \up{0{,}439} \\
Lỗ phải & \textbf{Severe} & \textbf{0{,}0} $\to$ \up{21{,}7} & \textbf{0{,}0} $\to$ \up{18{,}0} & \textbf{0{,}000} $\to$ \up{0{,}197} \\
\bottomrule
\end{tabular}
\end{table}

\textbf{Dòng đáng chú ý nhất là Severe của hai lỗ liên hợp: mô hình nền đạt recall đúng bằng 0.}
Nó chưa một lần dự đoán Severe cho lỗ liên hợp. Nên cải thiện ở đó không phải là tăng thêm bao
nhiêu phần trăm, mà là khoảng cách giữa \textbf{không làm được} và làm được một phần.

Cũng cần nói thẳng chỗ yếu: Severe F1 của lỗ liên hợp chỉ đạt 0{,}180 và 0{,}197, trong khi ống
sống đạt 0{,}623. Chính khoảng cách này là lý do toàn bộ Phase 3 tồn tại.

Bảng~\ref{tab:phase2auc} là cùng cách chia đó nhưng theo hai chỉ số \textbf{không phụ thuộc
ngưỡng}. Nó trả lời một câu khác với Bảng~\ref{tab:phase2detail}: cải thiện đến từ biểu diễn đặc
trưng tốt lên, hay chỉ từ việc điểm cắt quyết định dịch đi.

\begin{table}[htbp]
\centering\small
\caption{AUC và AUPRC theo điều kiện $\times$ lớp (nền $\to$ Hybrid), seed 42.}
\label{tab:phase2auc}
\setlength{\tabcolsep}{5pt}
\begin{tabular}{llcc}
\toprule
\textbf{Điều kiện} & \textbf{Lớp} & \textbf{AUC} & \textbf{AUPRC} \\
\midrule
Ống sống & Normal/Mild & 0{,}892 $\to$ \up{0{,}947} & 0{,}984 $\to$ \up{0{,}993} \\
Ống sống & Moderate    & 0{,}851 $\to$ \up{0{,}884} & 0{,}272 $\to$ \up{0{,}319} \\
Ống sống & \textbf{Severe} & 0{,}922 $\to$ \up{0{,}963} & 0{,}513 $\to$ \up{0{,}602} \\
\midrule
Lỗ trái & Normal/Mild & 0{,}794 $\to$ 0{,}789 & 0{,}932 $\to$ 0{,}924 \\
Lỗ trái & Moderate    & 0{,}758 $\to$ \down{0{,}655} & 0{,}387 $\to$ \down{0{,}262} \\
Lỗ trái & \textbf{Severe} & 0{,}815 $\to$ \up{0{,}858} & 0{,}147 $\to$ \up{0{,}174} \\
\midrule
Lỗ phải & Normal/Mild & 0{,}802 $\to$ 0{,}807 & 0{,}929 $\to$ 0{,}931 \\
Lỗ phải & Moderate    & 0{,}760 $\to$ \down{0{,}657} & 0{,}375 $\to$ \down{0{,}283} \\
Lỗ phải & \textbf{Severe} & 0{,}842 $\to$ 0{,}837 & 0{,}167 $\to$ \up{0{,}181} \\
\midrule
\multicolumn{2}{l}{\textbf{Trung bình lớp Severe}} & 0{,}860 $\to$ \up{0{,}886} & 0{,}276 $\to$ \up{0{,}319} \\
\bottomrule
\end{tabular}
\end{table}

Severe tăng đồng thời cả AUC lẫn AUPRC trên cả ba điều kiện. Vì hai chỉ số này đánh giá thứ tự xếp
hạng chứ không phụ thuộc ngưỡng, kết quả loại trừ khả năng cải thiện chỉ là hệ quả của việc dịch
điểm cắt: \textbf{biểu diễn đặc trưng thật sự tốt lên}.

Ngược lại, AUC của mức Moderate ở hai lỗ liên hợp \emph{giảm} 0{,}103. Nguyên nhân đã xác định và
ghi trong luận văn: phép tăng cường lật ngang ban đầu không hoán đổi nhãn trái/phải, nên nhãn
Moderate của hai bên bị lẫn. Đã sửa trong bản mã nguồn công bố. Lớp Severe ít bị ảnh hưởng hơn vì
các ca nặng nằm gần trục giữa, ít nhạy với đúng loại nhiễu nhãn đó.

\subsection{Một bằng chứng độc lập: mức đồng thuận so với bác sĩ}

Chẩn đoán về nhãn lỗ liên hợp ở mục~\ref{sec:t1} dựa vào hình học và vào kết quả của mô hình.
Có một cách kiểm tra thứ ba, không dùng cả hai: so \textbf{mức đồng thuận} của mô hình với mức đồng
thuận \textbf{giữa các bác sĩ với nhau}, đo bằng cùng một chỉ số là Cohen's kappa có trọng số bậc
hai (QWK).

\textbf{QWK đo cái gì.} Ba mức Normal/Mild, Moderate, Severe \textbf{có thứ tự}, trong khi độ chính
xác coi mọi cái sai như nhau. QWK phạt theo \textbf{bình phương khoảng cách} giữa hai mức: chấm
lệch hai bậc bị phạt \textbf{gấp bốn lần} lệch một bậc. Điều đó khớp với lâm sàng, vì gọi một ca
\textit{Severe} thành \textit{Moderate} khác hẳn gọi nó thành \textit{Normal}. Chỉ số này còn
\textbf{trừ phần trùng khớp do may rủi}: nếu hai người chấm chỉ tình cờ giống nhau vì cùng đoán theo
tỷ lệ nền, QWK bằng 0. Thang đo chạy từ 1 (trùng khớp hoàn toàn) qua 0 (không hơn may rủi) tới số âm.

Điều làm QWK trở thành \emph{bằng chứng} chứ không chỉ là thêm một chỉ số: \textbf{con người cũng
được đo bằng đúng chỉ số này}, nên đặt được mô hình lên chính cái thang mà giới chuyên môn dùng để
đánh giá lẫn nhau.
...
\textbf{Ma trận nhầm lẫn của nhãn ống sống} cho thấy cả cách tính lẫn ý nghĩa lâm sàng:

\begin{table}[htbp]
\centering\small
\caption{Nhãn ống sống, tập kiểm 1942 đĩa đệm. Hàng: bác sĩ chấm. Cột: mô hình đoán.}
\label{tab:cm}
\begin{tabular}{lccc}
\toprule
 & \textbf{Normal/Mild} & \textbf{Moderate} & \textbf{Severe} \\
\midrule
Normal/Mild & 1606 & 72 & 44 \\
Moderate    & 38 & 55 & 46 \\
Severe      & \textbf{8} & 16 & \textbf{57} \\
\bottomrule
\end{tabular}
\end{table}

Ô đáng chú ý nhất là số \textbf{8}: chỉ 8 trên 81 ca bác sĩ chấm \textit{Severe} bị mô hình gọi
thành \textit{Normal/Mild}. Đó vừa là kiểu sai nguy hiểm nhất trên lâm sàng, vừa là ô bị QWK phạt
nặng nhất. Ở chiều ngược lại có 44 ca báo động giả --- cũng bị phạt bằng đúng trọng số đó, nhưng
hậu quả lâm sàng nhẹ hơn nhiều.

\textbf{Và đây là con số giải thích vì sao không được dùng độ chính xác làm chỉ tiêu.} Mô hình đạt
độ chính xác \textbf{0{,}885} trên nhãn này. Nhưng 1722 trong 1942 dòng vốn là \textit{Normal/Mild},
nên một mô hình \textbf{chỉ đoán Normal/Mild cho mọi ca} đạt \textbf{0{,}887} --- \emph{cao hơn}.
Trong khi QWK của mô hình là 0{,}641 còn QWK của phép đoán một nhãn duy nhất đó là \textbf{đúng
bằng 0}.

Nói cách khác, theo độ chính xác thì mô hình thua một chiến lược vô dụng; theo QWK thì khoảng cách
là 0{,}641 so với 0. Đây cũng là câu trả lời cho việc độ chính xác tổng giảm khoảng 9 điểm so với
mô hình nền ở Bảng~\ref{tab:phase2}: phần độ chính xác bị mất là phần \textbf{không mang giá trị
lâm sàng}.
