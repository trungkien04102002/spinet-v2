...
Giải nhì RSNA 2024 & 2.5D: mã hoá từng lát, gộp bằng BiLSTM & \texttt{brendanartley}, cài đặt lại \\
Gộp bằng Transformer & 2.5D: mã hoá từng lát, gộp bằng tự chú ý & kiểu ViT, dựng làm đối chứng thứ hai \\
...
\textit{Giải nhì RSNA 2024.} Mỗi lát trong chín lát sagittal đi qua một bộ mã hoá ResNet18 riêng,
...
\textit{Gộp bằng Transformer.} Cùng bộ mã hoá ResNet18 theo từng lát, nhưng chín vectơ được coi là
...
\begin{tabular}{lcccc}
\toprule
\textbf{Chỉ số} & \textbf{SpineNetV2} & \textbf{Giải nhì RSNA} & \textbf{Transformer} & \textbf{Hybrid} \\
\midrule
