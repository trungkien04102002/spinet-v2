...
\item \textbf{Phát hiện về điều hòa xuyên-dữ-liệu}: khác các nghiên cứu attention một-dữ-liệu trước, ta chỉ ra chú ý kênh--không-gian giúp chỉ số Nặng in-domain nhưng \emph{làm tụt} transfer SPIDER xuống dưới backbone thuần, còn nhánh đa phương thức đông cứng phục hồi lại ($+0.034$ so CBAM-only, $p=0.011$) $\Rightarrow$ phù hợp với việc nhánh mô hình nền điều hòa hiện tượng học-vẹt của attention.
