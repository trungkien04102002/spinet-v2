...
|---|---|---|---|---|---|
| **0** | **Threshold/calibration** trên checkpoint sẵn: dump logits val 1 lần → coordinate-descent max macro-F1 / match cost 1:2:4 + logit-adjustment + τ-norm | **Không** | Vài giờ | Free, có số ngay; địa chỉ phần threshold của gap | ⬜ |
